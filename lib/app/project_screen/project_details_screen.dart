...
import 'package:allubmarket/controller/project_details_controller.dart';
                          ...
                          flexibleSpace: FlexibleSpaceBar(
                            background: Padding(
                              ...
                              child: Column(
                                children: [
                                  NetworkImageWidget(
                                    imageUrl: controller.pricingRequestModel
                                        .value.category!.icon
                                        .toString(),
                                    width: 44,
                                    height: 44,
                                  ...
                                  Text(
                                    "${controller.pricingRequestModel.value.category?.name}"
                                        .tr,
                                    textAlign: TextAlign.start,
                                    style: TextStyle(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${controller.pricingRequestModel.value.description}"
                                                .tr,
                                            textAlign: TextAlign.start,
                                            style: TextStyle(
                                              color: themeChange.getThem()
                                  ...
                                  controller.pricingRequestModel.value.images ==
                                              null ||
                                          controller.pricingRequestModel.value
                                              .images!.isEmpty
                                      ? SizedBox()
                                      : Container(
