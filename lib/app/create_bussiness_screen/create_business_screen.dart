...
import 'package:allubmarket/app/create_bussiness_screen/category_selection_screen.dart';
import 'package:allubmarket/app/create_bussiness_screen/edit_address_screen.dart';
import 'package:allubmarket/constant/constant.dart';
import 'package:allubmarket/constant/show_toast_dialog.dart';
import 'package:allubmarket/controller/create_business_controller.dart';
...
class CreateBusinessScreen extends StatelessWidget {
              ...
              actions: [
                DebouncedInkWell(
                  onTap: () {
                    ...
                    if (controller
                        .businessUrlTextFieldController.value.text.isEmpty) {
                      ShowToastDialog.showToast("Please enter a seo slug");
                    } else if (controller
                        .addressTextFieldController.value.text.isEmpty) {
                      ...
                      List<String> rawKeywords = controller
                          .metaKeywordsController.value.text
                          .split(',')
                          .map((k) => k.trim())
                          .where((k) => k.isNotEmpty)
                          .toList();
                      bool hasInvalidKeyword =
                          rawKeywords.any((k) => k.contains(' '));
                      if (hasInvalidKeyword) {
                        controller.metaKeywordsList.value = [];
                        ShowToastDialog.showToast(
                            "Please enter keywords in a comma-separated list without spaces.");
                        return;
                      }
                ...
                child: Column(
                  ...
                  children: [
                                    ...
                                    child: CupertinoSwitch(
                                      ...
                                      onChanged: (bool value) async {
                                        ...
                                        ShowToastDialog.showLoader(
                                            "Please wait");
                                        controller.isPermanentClosed.value =
                                            value;
                                        ...
                                        ShowToastDialog.showToast(value
                                            ? "Business closed"
                                            : "Business Reopened");
                                        Get.back();
                                      },
                    ...
                    TextFieldWidget(
                      title: 'Country',
                      controller:
                          controller.countryNameTextFieldController.value,
                      ...
                      suffix: CountryCodePicker(
                        onInit: (value) {
                          ...
                          controller.countryISOCodeController.value.text =
                    ...
                    InkWell(
                      onTap: () {
                        if (controller.nameTextFieldController.value.text
                            .trim()
                            .isEmpty) {
                          ShowToastDialog.showToast(
                              "Please enter product title to generate".tr);
                          return;
                        }
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFieldWidget(
                            ...
                            controller:
                                controller.nameTextFieldController.value,
                            hintText: 'Name',
                            onchange: (value) {
                              controller.businessSlug.value =
                                  controller.generateSlugAndUrl(
                                input: value,
                              );
                            },
                          ),
                          ...
                          TextFieldWidget(
                            controller:
                                controller.businessUrlTextFieldController.value,
                          ...
                          TextFieldWidget(
                              controller:
                                  controller.metaKeywordsController.value,
                              hintText: 'SEO Meta Keywords'.tr,
                              maxLine: 4,
                              onchange: (value) {
                                if (value.trim().isNotEmpty) {
                                  List<String> rawKeywords = value
                                      .split(',')
                                      .map((k) => k.trim())
                                      .where((k) => k.isNotEmpty)
                                      .toList();
                          ...
                          Padding(
                            ...
                            child: Text(
                              "Note: This field applies to web based businesses."
                                  .tr,
                              style: TextStyle(
                                  color: themeChange.getThem()
                                      ? AppThemeData.greyDark01
                          ...
                          DebouncedInkWell(
                            onTap: () async {
                              List<CategoryModel>? selectedCategories =
                                  await Get.to(CategorySelectionScreen(),
                                      arguments: {
                                    "selectedCategories":
                              ...
                              if (selectedCategories != null) {
                                ...
                                controller.categoryTextFieldController.value
                                        .text =
                                    controller.selectedCategory
                                        .map((e) => e.name)
                                        .join(", ");
                        ...
                        Get.to(EditAddressScreen(), arguments: {
                          ...
                          (value) {
                            if (value != null) {
                              ...
                              print(
                                  "Address: ${controller.address.value.toJson()}");
                              controller.addressTextFieldController.value.text =
                    ...
                    TextFieldWidget(
                      ...
                      controller:
                          controller.phoneNumberTextFieldController.value,
                      hintText: 'Phone',
                      inputFormatters: [
                    ...
                    TextFieldWidget(
                      controller: controller
                          .notesOfTheYelpTeamTextFieldController.value,
                      hintText:
  ...
  Future buildBottomSheet(
      BuildContext context, CreateBusinessController controller) {
