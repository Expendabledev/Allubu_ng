...
import 'package:allubmarket/controller/singup_controller.dart';
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Text(
                          controller.isAddAbusinessBtn.value == true
                              ? 'Create an account to add your business'.tr
                        ...
                        children: [
                          Expanded(
                            child: TextFieldWidget(
                              controller:
                                  controller.firstNameTextFieldController.value,
                          ...
                          Expanded(
                            child: TextFieldWidget(
                              controller:
                                  controller.lastNameTextFieldController.value,
                      ...
                      RoundedButtonFill(
                        ...
                        onPress: () {
                          if (controller.loginType.value ==
                            ...
                            if (controller.firstNameTextFieldController.value
                                .text.isEmpty) {
                              ShowToastDialog.showToast("Enter first name".tr);
                            } else if (controller.lastNameTextFieldController
                                .value.text.isEmpty) {
                              ShowToastDialog.showToast("Enter last name".tr);
                            } else if (controller
                                .emailTextFieldController.value.text.isEmpty) {
                              ShowToastDialog.showToast(
                                  "Enter email address".tr);
                            } else if (controller.passwordTextFieldController
                                .value.text.isEmpty) {
                              ShowToastDialog.showToast("Enter Password".tr);
                            } else if (controller.phoneNumberTextFieldController
                                .value.text.isEmpty) {
                              ShowToastDialog.showToast(
              ...
              bottomNavigationBar: Padding(
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    if (controller.isAddAbusinessBtn.value == true)
                      RoundedButtonBorder(
                        icon:
                            SvgPicture.asset("assets/icons/ic_google.svg.svg"),
                    ...
                    Platform.isIOS && controller.isAddAbusinessBtn.value == true
                        ? RoundedButtonFill(
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(
                          horizontal: 16,
                          vertical: controller.isAddAbusinessBtn.value == true
                              ? 20
                              : 10),
                      child: Text.rich(
                        textAlign: TextAlign.center,
                        TextSpan(
                          text: 'already_have_account'.trParams(
                              {'appName': Constant.applicationName}).tr,
                          style: TextStyle(
                            fontSize: 14,
