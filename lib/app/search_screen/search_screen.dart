...
import 'package:allubmarket/controller/search_controller.dart';
              ...
              child: Column(
                ...
                children: [
                  TextFieldWidget(
                    ...
                    suffix: controller
                            .categoryTextFieldController.value.text.isNotEmpty
                        ? DebouncedInkWell(
                            onTap: () {
                    ...
                    suffix: DebouncedInkWell(
                      onTap: () {
                        controller.searchPlaces(
                            controller.locationTextFieldController.value.text);
                      },
                      child: Padding(
                                  ...
                                  : Column(
                                      ...
                                      children: [
                                        ...
                                        Wrap(
                                          spacing: 8,
                                          runSpacing: 8,
                                          children: controller.categoryHistory
                                              .map((item) {
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        ...
                                                                        style:
                                                                          ...
                                                                          fontSize:
                                                                              14,
                                                                          fontFamily: parentCategory.indexOf(subcategory) == 0
