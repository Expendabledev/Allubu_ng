...
import 'package:yelpify/app/check_in_screen/check_in_list_screen.dart';
...
import 'package:yelpify/app/profile_screen/all_review_screen.dart';
import 'package:yelpify/app/profile_screen/edit_profile_screen.dart';
...
import 'package:yelpify/controller/profile_controller.dart';
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    businessModel.recommendUserId!.contains(FireStoreUtils.getCurrentUid())
                                                        ...
                                                        : FireStoreUtils.getCurrentUid() != '' && FireStoreUtils.getCurrentUid().isNotEmpty
                                                            ? Column(
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                                  Text(
      ...
      children: [
        ClipOval(
          ...
          child: Padding(
            ...
            child: Constant.svgPictureShow(imagePath, themeChange.getThem() ? AppThemeData.greyDark03 : AppThemeData.grey03, null, null),
          ),
        )),
        SizedBox(
          height: 5,
