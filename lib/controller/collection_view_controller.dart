...
class CollectionViewController extends GetxController {
  ...
  Future<void> getArgument() async {
    ...
    if (argumentData != null) {
      ...
      collectionNameTextFieldController.value.text =
          bookmarkModel.value.name.toString();
      collectionDescriptionTextFieldController.value.text =
          bookmarkModel.value.description.toString();
  ...
  Future<void> getUser() async {
    await FireStoreUtils.getUserProfile(bookmarkModel.value.ownerId.toString())
        .then(
      (value) {
        if (value != null) {
  ...
  Future<void> updateMyBookmark() async {
    ...
    bookmarkModel.value.description =
        collectionDescriptionTextFieldController.value.text;
    ...
    bookmarkModel.value.location = LatLngModel(
