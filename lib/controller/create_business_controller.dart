...
import 'package:yelpify/models/ai_genrated_content_model.dart';
  ...
  void getArgument() {
    ...
    if (argumentData != null) {
      if (argumentData['businessModel'] != null) {
        ...
        countryISOCodeController.value.text = businessModel.value.countryISOCode ?? '';
      ...
      (value) {
        ...
        if (value != null) {
          if (value['success'] == "Failed") {
            ...
            AiGeneratedContentContentModel aiTitleDescriptionModel = AiGeneratedContentContentModel.fromJson(value);
            nameTextFieldController.value.text = aiTitleDescriptionModel.data!.title ?? "";
            descriptionTextFieldController.value.text = aiTitleDescriptionModel.data!.description ?? "";
            selectedCategory.value = aiTitleDescriptionModel.data!.category ?? [];
            categoryTextFieldController.value.text = selectedCategory.map((e) => e.name).join(", ");
            metaKeywordsList.value = aiTitleDescriptionModel.data!.keywords!.split(',').map((e) => e.trim()).toList();
            metaKeywordsController.value.text = metaKeywordsList.join(', ');
            ShowToastDialog.showToast("Title and Description generated successfully.");
          }
        }
      },
    );
